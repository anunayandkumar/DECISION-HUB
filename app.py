            ...
            if message is not None and category is not None:
                ...
                if category == "success":
                    if message == "email not verified":
                        ...
                        return redirect(url_for("main_dashboard", username=email))
...
def main_dashboard():
    ...
    if username and 'admin' not in username:
        ...
        return render_template('main_dashboard.html', username=username, data=user_queries[username])
    else:
